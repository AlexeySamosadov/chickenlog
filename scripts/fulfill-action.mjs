/** Autonomous order fulfilment for ChickenLog — GitHub Action on new issue.
...
comment(["✅ **Payment verified — your ChickenLog Pro license:**", "", "Open ChickenLog → **Pro** → *Have a key?* → paste:", "", "```", license, "```", "", "Lifetime, works offline. Thanks for supporting the flock 🐔"].join("\n"));
